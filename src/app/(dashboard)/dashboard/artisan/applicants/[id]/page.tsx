        ...
        <div className="max-w-2xl mx-auto p-8 bg-white rounded-lg shadow">
            ...
            <div className="mb-6">
                ...
                <div className="bg-gray-50 p-4 rounded border">
                    <p className="font-bold text-blue-700">{Program.title}</p>
            ...
            <div className="mb-4">
                ...
                <p className="bg-gray-100 p-3 rounded text-gray-700 whitespace-pre-line">{message}</p>
            </div>
            {motivation && (
                <div className="mb-4">
                    <h4 className="font-semibold mb-1">Motivation</h4>
                    <p className="bg-gray-100 p-3 rounded text-gray-700 whitespace-pre-line">{motivation}</p>
                </div>
            )}
            ...
            <div className="mb-4">
                ...
                {cvPortfolioUrl ? (
                    <a
                        ...
                        className="flex items-center gap-2 px-4 py-2 bg-blue-50 border border-blue-200 rounded hover:bg-blue-100 transition w-fit"
                    >
